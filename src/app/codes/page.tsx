...
const GROUPS: { key: string; labelKey: string }[] = [
  { key: "LOB", labelKey: "sow.lob" },
  { key: "Milestone", labelKey: "codes.milestone" },
];
  ...
  return (
    <div className="p-6 flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">{t("nav.codes")}</h1>
        ...
        {!isReadOnly && (
          ...
          >
            <Plus className="w-4 h-4" />{t("codes.add")}
          </button>
        )}
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setDeleteTarget(null)}>
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm mx-4" onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              <h2 className="text-base font-semibold text-gray-900">{t("codes.delete_title")}</h2>
